...
"""Image reconstruction through Variational Inference estimate using pre-trained StyleGAN-ADA."""
...
from bayesmap_recon import cosine_distance, constructForwardModel, getVggFeatures, saveImage
...
def project(
    ...
    *,
    ...
    nrS = 6 # generates 6 samples at each step during optimisation to compute variational loss. After optimisation, can sample more.
...
def run_projection(
    ...
    for filename in imageList:
        ...
        saveImage(target[0], filepath=f'{outdir}/{fnshort}_target.jpg', target_res=(G.img_resolution,G.img_resolution))
        ...
        nrS = num_samples # how many samples to take. the first sample will have zero noise, and represent the mean of the posterior
